...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  const links = [
    ...
    { href: "/customers", label: "Design partners" },
...
const STORAGE_KEY$1 = "ontologia.theme";
function getInitial() {
...
const STORAGE_KEY = "ontologia.cookies";
...
function writeConsent(c) {
  ...
  window.dispatchEvent(
    new CustomEvent("ontologia:consent", { detail: c })
  );
}
function CookieBanner() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("ontologia:open-cookies", reopen);
    return () => window.removeEventListener("ontologia:open-cookies", reopen);
  }, []);
  function acceptAll() {
    writeConsent({
      level: "all",
  ...
  return /* @__PURE__ */ jsx(
    R,
    {
      ...
      hasBackground: false,
      children: showPrefs ? /* @__PURE__ */ jsx(
        PreferencesModal,
        {
          analytics,
          marketing,
