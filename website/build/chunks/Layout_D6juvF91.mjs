...
const $$Astro$4 = createAstro("https://ontologia.com");
...
}, "/sessions/bold-blissful-hawking/mnt/Desktop--Ontologia/website/src/components/JsonLd.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  const siteOrigin = (Astro2.site ?? new URL("https://ontologia.com")).toString().replace(/\/$/, "");
  ...
  const organizationLd = {
    ...
    description: "Ontologia is the source of truth for the concepts your AI and data pipelines depend on \u2014 design, version, and ship knowledge graphs and SKOS / OWL taxonomies through a stable JSON-LD API.",
    contactPoint: [
      {
        "@type": "ContactPoint",
        email: "hello@ontologia.com",
