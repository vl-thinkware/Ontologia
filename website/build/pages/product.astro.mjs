  ...
  const productJsonLd = [
    {
      ...
      operatingSystem: "Web",
      url: "https://semlify.com/product",
      description: "Schema canvas, taxonomies tree, tables view, governed change history, validation panel, AI helpers, and a clean JSON-LD API.",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: "Product",
          item: "https://semlify.com/product"
        }
      ]
    }
  ];
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Product overview \u2014 Semlify", "description": "Schema canvas, taxonomies tree, tables view, governed change history, validation, AI helpers, and a JSON-LD API. Every view of one versioned ontology.", "current": "/product", "jsonLd": productJsonLd }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ProductPageNav", $$ProductPageNav, { "current": "/product" })}  ${maybeRenderHead()}<section class="py-16 md:py-24" style="background: var(--marketing-gradient-hero);"> <div class="container-page text-center"> <p class="text-eyebrow">Product</p> <h1 class="text-display mt-3" style="font-size: clamp(2.25rem, 1.5rem + 3vw, 3.5rem);">
...
}, "/sessions/bold-blissful-hawking/mnt/Ontologia/website/src/pages/product/index.astro", void 0);

const $$file = "/sessions/bold-blissful-hawking/mnt/Ontologia/website/src/pages/product/index.astro";
const $$url = "/product";
