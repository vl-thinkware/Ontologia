...
/* empty css                                   */
import s$1 from 'classnames';
import { Tooltip, Direction, Slot } from 'radix-ui';
...
const d=()=>{},P=e.createContext(void 0);const R=e.forwardRef((a,s)=>e.useContext(P)===void 0?e.createElement(Tooltip.Provider,{delayDuration:200},e.createElement(Direction.Provider,{dir:"ltr"},e.createElement(I,{...a,ref:s}))):e.createElement(A,{...a,ref:s}));R.displayName="Theme";const I=e.forwardRef((a,s$1)=>{const{appearance:r=s.appearance.default,accentColor:c=s.accentColor.default,grayColor:l=s.grayColor.default,panelBackground:p=s.panelBackground.default,radius:n=s.radius.default,scaling:t=s.scaling.default,hasBackground:i=s.hasBackground.default,...u}=a,[h,m]=e.useState(r);e.useEffect(()=>m(r),[r]);const[y,g]=e.useState(c);e.useEffect(()=>g(c),[c]);const[v,C]=e.useState(l);e.useEffect(()=>C(l),[l]);const[k,f]=e.useState(p);e.useEffect(()=>f(p),[p]);const[B,x]=e.useState(n);e.useEffect(()=>x(n),[n]);const[T,b]=e.useState(t);return e.useEffect(()=>b(t),[t]),e.createElement(A,{...u,ref:s$1,isRoot:true,hasBackground:i,appearance:h,accentColor:y,grayColor:v,panelBackground:k,radius:B,scaling:T,onAppearanceChange:m,onAccentColorChange:g,onGrayColorChange:C,onPanelBackgroundChange:f,onRadiusChange:x,onScalingChange:b})});I.displayName="ThemeRoot";const A=e.forwardRef((a$1,s$2)=>{const r=e.useContext(P),{asChild:c,isRoot:l,hasBackground:p,appearance:n=r?.appearance??s.appearance.default,accentColor:t=r?.accentColor??s.accentColor.default,grayColor:i=r?.resolvedGrayColor??s.grayColor.default,panelBackground:u=r?.panelBackground??s.panelBackground.default,radius:h=r?.radius??s.radius.default,scaling:m=r?.scaling??s.scaling.default,onAppearanceChange:y=d,onAccentColorChange:g=d,onGrayColorChange:v=d,onPanelBackgroundChange:C=d,onRadiusChange:k=d,onScalingChange:f=d,...B}=a$1,x=c?Slot.Root:"div",T=i==="auto"?a(t):i,b=a$1.appearance==="light"||a$1.appearance==="dark",S=p===void 0?l||b:p;return e.createElement(P.Provider,{value:e.useMemo(()=>({appearance:n,accentColor:t,grayColor:i,resolvedGrayColor:T,panelBackground:u,radius:h,scaling:m,onAppearanceChange:y,onAccentColorChange:g,onGrayColorChange:v,onPanelBackgroundChange:C,onRadiusChange:k,onScalingChange:f}),[n,t,i,T,u,h,m,y,g,v,C,k,f])},e.createElement(x,{"data-is-root-theme":l?"true":"false","data-accent-color":t,"data-gray-color":T,"data-has-background":S?"true":"false","data-panel-background":u,"data-radius":h,"data-scaling":m,ref:s$2,...B,className:s$1("radix-themes",{light:n==="light",dark:n==="dark"},B.className)}))});A.displayName="ThemeImpl";
...
const PLANS = [
  {
    ...
    cta: { label: "Start free", href: "https://app.ontologia.com/signup" }
  },
  {
    id: "team",
    name: "Team",
    ...
    cta: { label: "Start trial", href: "https://app.ontologia.com/signup?plan=team" },
    emphasis: true
  },
  {
    id: "business",
    ...
    cta: { label: "Start trial", href: "https://app.ontologia.com/signup?plan=business" }
  },
  {
    id: "enterprise",
    name: "Enterprise",
    ...
    cta: { label: "Talk to sales", href: "mailto:hello@ontologia.com" }
  }
];
  ...
  return /* @__PURE__ */ jsx(
    R,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4", children: PLANS.map((plan) => {
...
const $$Pricing = createComponent(($$result, $$props, $$slots) => {
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes \u2014 50% off the Team plan for two years for companies under $5M ARR or 10 employees. Apply via hello@ontologia.com with a one-line description of what you're building."
    },
    {
      q: "How do you handle GDPR?",
      a: "Ontologia is hosted in EU regions for European customers (Pro and above). We sign DPAs, maintain a public sub-processors list, and our Standard Contractual Clauses cover non-EU data flows. See /security for the full posture."
    },
    {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Pricing \u2014 Ontologia", "description": "Workspace-based pricing with no per-seat tax. Free tier for evaluation, Team for production AI teams, Business for compliance needs, Enterprise for self-host and custom contracts.", "current": "/pricing" }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="py-16 md:py-24" style="background: var(--marketing-gradient-hero);"> <div class="container-page text-center"> <p class="text-eyebrow">Pricing</p> <h1 class="text-display mt-3" style="font-size: clamp(2.25rem, 1.5rem + 3vw, 3.5rem);">
...
</p> </div> </section>  <section class="py-16 md:py-24"> <div class="container-page"> ${renderComponent($$result2, "PricingTable", PricingTable, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/sessions/bold-blissful-hawking/mnt/Desktop--Ontologia/website/src/components/PricingTable.tsx", "client:component-export": "default" })} </div> </section>  <section class="py-16 md:py-20" style="background: var(--gray-2);"> <div class="container-page"> <header class="mx-auto mb-10 max-w-2xl text-center"> <p class="text-eyebrow">Add-ons</p> <h2 class="text-headline mt-2" style="font-size: clamp(1.75rem, 1rem + 2vw, 2.5rem);">
Top up what you need, when you need it.
</h2> </header> <div class="mx-auto grid max-w-4xl grid-cols-1 gap-4 md:grid-cols-3"> ${[
    {
...
+
</span> </span> </summary> <p class="mt-3 text-[14px] leading-relaxed" style="color: var(--gray-11);"> ${faq.a} </p> </details>`)} </div> </div> </section> ${renderComponent($$result2, "CtaBlock", $$CtaBlock, { "title": "Ready to ship a versioned ontology?", "subtitle": "Start with the Free tier. Upgrade when your RAG pipeline outgrows it.", "primaryLabel": "Start free", "secondaryLabel": "See enterprise plans", "secondaryHref": "mailto:hello@ontologia.com?subject=Enterprise%20pricing" })} ` })}`;
}, "/sessions/bold-blissful-hawking/mnt/Desktop--Ontologia/website/src/pages/pricing.astro", void 0);

const $$file = "/sessions/bold-blissful-hawking/mnt/Desktop--Ontologia/website/src/pages/pricing.astro";
const $$url = "/pricing";
