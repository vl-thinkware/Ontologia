...
const $$404 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Not found \u2014 Ontologia", "description": "The page you're looking for doesn't exist." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="container-page flex min-h-[60vh] flex-col items-center justify-center py-20 text-center"> <p class="text-[12px] font-bold uppercase tracking-wider" style="color: var(--gray-11);">
404
...
}, "/sessions/bold-blissful-hawking/mnt/Desktop--Ontologia/website/src/pages/404.astro", void 0);

const $$file = "/sessions/bold-blissful-hawking/mnt/Desktop--Ontologia/website/src/pages/404.astro";
const $$url = "/404";
