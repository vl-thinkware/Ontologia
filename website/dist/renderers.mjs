import e__default, { createElement } from 'react';
...
async function check(Component, props, children) {
	...
	if (Component.prototype != null && typeof Component.prototype.render === 'function') {
		return e__default.Component.isPrototypeOf(Component) || e__default.PureComponent.isPrototypeOf(Component);
	}
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
	...
	for (const [key, value] of Object.entries(slotted)) {
		...
		slots[name] = e__default.createElement(StaticHtml, {
	...
	if (newChildren != null) {
		newProps.children = e__default.createElement(StaticHtml, {
			hydrate: needsHydration(metadata),
			value: newChildren,
		});
	}
	...
	const vnode = e__default.createElement(Component, newProps);
	const renderOptions = {
