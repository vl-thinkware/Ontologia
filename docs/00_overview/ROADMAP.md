...
Time-boxed against an assumed kickoff of **May 2026** with the two-founder team described in [HIRING_PLAN.md](https://www.notion.so/09_team/HIRING_PLAN.md). Dates are plans, not commitments; scope is the commitment.

## Snapshot

|Phase|Window|Theme|Release label|
|---|---|---|---|
|0|May 2026 (1 month)|Foundations|`0.1.x` internal|
|1|June 2026 (1 month)|MVP (François ? Hind ?)|`0.5.x` closed beta|
|2|July 2026 – Jan 2027|Paid launch + GA and commercial ramp|`1.0` open beta|
|3|Jan 2027 onward|Enterprise-ready + collaboration depth|`1.x`|
...
- CI/CD (GitHub Actions → [Fly.io](http://Fly.io) + Vercel), observability baseline (Sentry free + Grafana Cloud free).
...
## Phase 1 — MVP with design partners

**Goal.** Ship to 2–3 partners and validate the core authoring loop against the mockup feature set. (Maybe we could ask Hind, François Serra to challenge the MVP, free and easy to do)

Must-have features M1–M7 from [FEATURES.md](https://www.notion.so/01_product/FEATURES.md):
...
## Phase 2.1 — GA and commercial ramp
...
- **Real-time collaboration server** (Yjs / Automerge): cursors, live co-edit on the concept detail (Not sure about this one - Wahou effect but useless)
...
## Phase 3 — Enterprise readiness and branching (months 15+)
...
- Marketplace of published public ontologies (FIBO, SKOS, [schema.org](http://schema.org) overlays; community-contributed verticals).
...
- **A feature ships only when (a) the MVP metric is healthy _or_ (b) a paying customer is waiting for it and has signed.**

## Related

- [Vision](https://www.notion.so/VISION.md)
- [Product Requirements Document](https://www.notion.so/01_product/PRD.md)
- [Features](https://www.notion.so/01_product/FEATURES.md)
- [Refinements & open questions](https://www.notion.so/01_product/REFINEMENTS.md)
- [Launch Checklist](https://www.notion.so/10_launch/LAUNCH_CHECKLIST.md)
- [Hiring Plan](https://www.notion.so/09_team/HIRING_PLAN.md)
- [Financial Projections](https://www.notion.so/08_finance/FINANCIAL_PROJECTIONS.md)